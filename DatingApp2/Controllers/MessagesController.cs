...
namespace DatingApp2.Controllers
{
    public class MessagesController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<ActionResult<MessageDTO>> CreateMessage(CreateMessageDTO createMessagesDto)
        {
            ...
            var recipient = await _userRepository.GetUserByNameAsync(createMessagesDto.RecipientUsername);
